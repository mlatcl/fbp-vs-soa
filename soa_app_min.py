...
class App():
    ...
    def evaluate(self):
        allocations_info = self.allocate_drivers()
        return self.get_outputs(allocations_info)

    def get_outputs(self, allocation_info):
        driver_allocations = []
        das = allocation_info['driver_allocations']
        for da in das:
        ...
        ride_infos = []
        ris = allocation_info['ride_infos']
        for ri in ris:
        ...
        ride_wait_times = []
        rwts = allocation_info['ride_wait_times']
        for rwt in rwts:
    ...
    def allocate_drivers(self):
        url = base_url + 'driver-request/allocate_drivers'
